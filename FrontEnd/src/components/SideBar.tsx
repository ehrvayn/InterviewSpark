...
export default function Sidebar({ currentPage, onNavigate }: SidebarProps) {
  ...
  return (
    <>
      <div className="lg:hidden fixed top-0 left-0 right-0 z-40 h-16 bg-[#0a0f18]/90 border-b border-white/5 backdrop-blur-xl flex items-center justify-between px-6">
        <button
      ...
      <aside
        className={`fixed lg:sticky top-0 left-0 h-screen w-72 bg-[#0d121b] border-r border-white/5 flex flex-col z-50 transition-transform duration-300 ease-in-out ${
            ...
            <div className="relative z-10 flex flex-col gap-4">
              <div className="flex items-center gap-3">
                <span className="text-[9px] font-black uppercase tracking-[0.2em] text-slate-500 flex items-center gap-2">
                  <SiBasicattentiontoken className="text-blue-600" /> Credits:
                </span>
